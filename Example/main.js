...
exports.default = {
	...
	methods: {
		...
		calcPercentage: function calcPercentage() {
			console.log("calc percentage");
			var result = (this.getPresent() - this.start) / (this.end - this.start) * 100;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "C:\\Users\\joost.lawerman\\.homestead\\Code\\vue-website\\resources\\assets\\js\\components\\percentage.vue"
...
var _percentage = require("./components/percentage.vue");
...
// import createGuestEntry from "./components/createGuestEntry.vue";

// Vue.use(require("vue-resource"));
// Vue.use(require("snackbarlightjs"));

// Vue.component("ip-entry",ipEntry);
// Vue.component("guest-entry",guestEntry);
// Vue.component("guest-form",createGuestEntry);

Vue.component("live-percentage", _percentage2.default);
...
},{"./components/percentage.vue":5,"vue":3}]},{},[6]);
